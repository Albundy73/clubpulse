...
export default function ClubPulseDashboard() {
  ...
  function completeOnboarding() {
    if (!preferences.countryId || !preferences.cityId || preferences.sportIds.length === 0) return;
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      <header className="border-b bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-5">
          <div><div className="text-2xl font-black tracking-tight">ClubPulse</div><div className="text-sm text-slate-500">Your city. Your clubs. One place.</div></div>
